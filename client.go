...
import (
	...
	bc "github.com/mrrobotxrp/Sayan-2506/diplom/blockchain"
	nt "github.com/mrrobotxrp/Sayan-2506/diplom/network"
)
...
func handleClient() {
	...
	for {
		...
		case "/user":
			...
			switch strings.TrimRight(splited[1], "\r\n") {
			case "address":
				userAddress()
			case "purse":
				userPurse()
...
func chainTX(splited []string) {
	...
	num, err := strconv.Atoi(strings.TrimRight(splited[2], "\r\n"))
	if err != nil {
...
func chainBalance(splited []string) {
	...
	printBalance(strings.TrimRight(splited[1], "\r\n"))
}
